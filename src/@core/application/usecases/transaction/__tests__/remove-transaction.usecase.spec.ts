import { RemoveTransactionUseCase, CreateTransactionUseCase } from '..';
...
describe('Remove Transaction Use Case', () => {
  ...
  it('should be able to remove a transaction', async () => {
    ...
    const transactionFound = await transactionRepository.findOneById(
      transaction.id,
    );
